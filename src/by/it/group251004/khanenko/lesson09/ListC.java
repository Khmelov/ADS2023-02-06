package by.it.group251004.khanenko.lesson09;
...
public class ListC<E> implements List<E> {
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        if (fromIndex < 0 || toIndex > _current || fromIndex > toIndex) {
            by.it.group251004.krutko.lesson09.ListC<E> subList = new by.it.group251004.krutko.lesson09.ListC<>(toIndex - fromIndex);
