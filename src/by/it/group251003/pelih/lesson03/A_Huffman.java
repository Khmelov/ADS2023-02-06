package by.it.group251003.pelih.lesson03;
...
public class A_Huffman {
    ...
    abstract class Node implements Comparable<by.it.group251003.pelih.lesson03.A_Huffman.Node> {
        ...
        //или для сортировок
        @Override
        public int compareTo(by.it.group251003.pelih.lesson03.A_Huffman.Node o) {
    ...
    private class InternalNode extends by.it.group251003.pelih.lesson03.A_Huffman.Node {
        //внутренный узел дерева
        by.it.group251003.pelih.lesson03.A_Huffman.Node left;  //левый ребенок бинарного дерева
        by.it.group251003.pelih.lesson03.A_Huffman.Node right; //правый ребенок бинарного дерева

        //для этого дерева не существует внутренних узлов без обоих детей
        //поэтому вот такого конструктора будет достаточно
        InternalNode(by.it.group251003.pelih.lesson03.A_Huffman.Node left, by.it.group251003.pelih.lesson03.A_Huffman.Node right) {
    ...
    private class LeafNode extends by.it.group251003.pelih.lesson03.A_Huffman.Node {
        //лист
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (ind != ' ') {
                ...
                } else count.put(ind, 1);
            }
        }

        //2. перенесем все символы в приоритетную очередь в виде листьев
        PriorityQueue<by.it.group251003.pelih.lesson03.A_Huffman.Node> priorityQueue = new PriorityQueue<>();
        for (Map.Entry<Character, Integer> ind : count.entrySet()) {
            by.it.group251003.pelih.lesson03.A_Huffman.Node nodeind = new by.it.group251003.pelih.lesson03.A_Huffman.LeafNode(ind.getValue(), ind.getKey());
            priorityQueue.add(nodeind);
        }
        ...
        by.it.group251003.pelih.lesson03.A_Huffman.Node elem = null;
        while (priorityQueue.size() != 1) {
            elem = new by.it.group251003.pelih.lesson03.A_Huffman.InternalNode(priorityQueue.poll(), priorityQueue.poll());
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        by.it.group251003.pelih.lesson03.A_Huffman instance = new by.it.group251003.pelih.lesson03.A_Huffman();
