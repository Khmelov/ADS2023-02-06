package by.it.group251003.kukhotskovolets.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        while (priorityQueue.size() != 1){
            Node left_node = priorityQueue.poll();
            Node right_node = priorityQueue.poll();
            Node parent = new InternalNode(left_node, right_node);
        ...
        root.fillCodes(String.valueOf(sb));
        for (int i = 0; i < s.length(); i++) {
