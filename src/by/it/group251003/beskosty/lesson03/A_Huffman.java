package by.it.group251003.beskosty.lesson03;
...
public class A_Huffman {
    ...
    private class LeafNode extends Node {
        ...
        LeafNode(int frequence, Character symbol) {
            super(frequence);
            this.symbol = symbol;
        }
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Map.Entry<Character, Integer> CurrEl : count.entrySet()) {
            priorityQueue.add(new LeafNode(CurrEl.getValue(), CurrEl.getKey()));
        }
        ...
        while (priorityQueue.size() > 1) {
            ...
            node3 = new InternalNode(node1, node2);
