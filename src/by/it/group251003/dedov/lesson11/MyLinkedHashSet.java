package by.it.group251003.dedov.lesson11;
...
public class MyLinkedHashSet<E> implements Set<E> {
    ...
    private int getHash(Object o) {return (o.hashCode() & 0x7FFFFFFF) % map.length; }

    MyLinkedHashSet() { map = new ListNode[defaultSize]; }

    MyLinkedHashSet(int size) { map = new ListNode[size]; }
    private void resize() {
