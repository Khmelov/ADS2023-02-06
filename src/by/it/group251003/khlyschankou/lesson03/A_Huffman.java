package by.it.group251003.khlyschankou.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        PriorityQueue<by.it.group251003.khlyschankou.lesson03.A_Huffman.Node> priorityQueue = new PriorityQueue<>();
        for (Map.Entry<Character, Integer> entry: count.entrySet())
        {
            Character key = entry.getKey();
            Integer value = entry.getValue();

            priorityQueue.add(new by.it.group251003.khlyschankou.lesson03.A_Huffman.LeafNode(value,  key));
        }
        ...
        by.it.group251003.khlyschankou.lesson03.A_Huffman.Node a, b, c;
        while (priorityQueue.size() != 1) {
            a = priorityQueue.poll();
            b = priorityQueue.poll();
            c = new by.it.group251003.khlyschankou.lesson03.A_Huffman.InternalNode(a,b);
            priorityQueue.add(c);
        }
