...
public class MyLinkedHashSet<E> implements Set<E> {
    ...
    // Внутренний статический класс Node для хранения элементов множества
    private static class Node<E> {
        E data;
        Node<E> previous;
       Node<E> next;

        // Конструктор Node, инициализирующий элемент и обе ссылки
        private Node(E data) {
            this.data = data;
            this.next = null;
            this.previous = null;
    ...
    // Внутренний статический класс List для хранения списка элементов внутри бакета
    ...
    // Объявление и инициализация массива, который является массивом списков (списков элементов множества)
    transient List<E>[] elementData;

    // Конструктор
    public MyLinkedHashSet() {
        elementData = new List[capacity]; // Создание массива списков заданной емкости
        for (int i = 0; i < capacity; i++) {
            elementData[i] = new List<E>(); // Инициализация каждого элемента массива пустым списком
        }
        size = 0;
    }
