package by.it.group251003.ilysiakoff.lesson12;
...
public class MyAvlMap implements Map<Integer, String> {
    ...
    private Node searchNode(Node n, Integer key) {
        while(n != null) {
    ...
    private Node insertNode(Node n, Integer key, String value) {
    ...
    private Node removeNode(Node n, Integer key) {
    ...
    public boolean containsKey(Object key) {
        Node n = searchNode(head, (Integer)key);
        if (n == null) {
            return false;
        }
        return true;
    ...
    public String remove(Object key) {
        ...
        head = removeNode(head, (Integer) key);
        _size--;
        return n.value;
    }
