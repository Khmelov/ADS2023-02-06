package by.it.group251002.kiseliov.lesson12;
...
public class MySplayMap implements NavigableMap<Integer, String> {
    ...
    public String toString() {
        ...
        if (HEAD_POINTER != null) {
            SplayNode temp = getMostLeftChild(HEAD_POINTER);
    ...
    public String put(Integer key, String value) {
        ...
        if (HEAD_POINTER != null) {
            ...
            HEAD_POINTER = new SplayNode(key, value, null);
            return null;
        }
    }
    ...
    public String remove(Object key) {
        ...
        if (!flag) {
            String prevValue = HEAD_POINTER.value;
            temp = HEAD_POINTER.right;
            SIZE_OF_MAP--;
            if (temp != null) {
                ...
                HEAD_POINTER.left = HEAD_POINTER.left.left;
                HEAD_POINTER.left.parent = HEAD_POINTER;

            } else {
                HEAD_POINTER = HEAD_POINTER.left;
                HEAD_POINTER.parent = null;
            }
            return prevValue;
        } else {
            return null;
