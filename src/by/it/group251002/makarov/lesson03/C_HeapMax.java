...
public class C_HeapMax {
    ...
    private class MaxHeap {
        ...
        void swap(int a, int b){    // меняет местами 2 элемента
            long x = heap.get(a);
        ...
        private void siftDown(int i) { //просеивание вверх
            ...
            int left = i*2;
            int right = i*2+1;
            if(heap.size()>right && heap.get(right)>heap.get(i)){ //если существование правого возможно, то переходим к нему
                i=right;
            }
            ...
            if (start != i) { //если меняет свое значение
                swap(start, i);
                siftDown(i);
            }
        }
