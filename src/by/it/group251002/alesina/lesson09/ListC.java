...
public class ListC<E> implements List<E> {
    ...
    @Override
    public boolean removeAll(Collection<?> c) { //удаляет то, что принадлежит коллекции
    ...
    @Override
    public boolean retainAll(Collection<?> c) {  //удаляет то, что не принадлежит коллекции
        boolean removed = false;
        int i = 0;
        while (i < ListSize){
            if (!c.contains(MyList[i])){
