package by.it.group251001.homeliyanskaya.lesson13;
...
public class GraphA {
    ...
    // Ключ - узел, значение - список смежных узлов
    static Stack<String> ans;
    // Стек для хранения результатов обхода
    ...
    public static void main(String[] args) {
        ...
        // Запуск DFS для всех узлов графа
