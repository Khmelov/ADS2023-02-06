package by.it.group251001.hatalskiy.lesson13;

import java.util.*;

public class GraphA { static void topologicalSortUnit(String node, Map<String, ArrayList<String>> graph, Set<String> visited, Stack<String> stack) {
    visited.add(node);
