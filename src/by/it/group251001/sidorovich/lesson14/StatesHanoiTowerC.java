package by.it.group251001.sidorovich.lesson14;
...
public class StatesHanoiTowerC {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < N; i++)
            steps_heights[i] = -1;
        by.it.group251001.sidorovich.lesson14.StatesHanoiTowerC.DSU dsu = new by.it.group251001.sidorovich.lesson14.StatesHanoiTowerC.DSU(max_size);
