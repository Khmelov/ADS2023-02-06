...
public class GraphC {
    ...
    public static void main(String[] args) {
        ...
        entryList.sort(new by.it.group251001.krivitsky.lesson13.GraphC.MapEntryComparator());
        ...
        for (String node : vertices) {
            if (!visited.contains(node)) {
                ...
                path.sort(new by.it.group251001.krivitsky.lesson13.GraphC.StringComparator());
