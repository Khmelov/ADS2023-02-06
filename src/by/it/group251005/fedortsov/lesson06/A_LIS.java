package by.it.group251005.fedortsov.lesson06;
...
public class A_LIS {
    ...
    int getSeqSize(InputStream stream) throws FileNotFoundException {
        ...
        //    for(int j = 0; j < i; j++) {
        //        if (m[i] > m[j]) {
        //            longestIncreasing[i] = Math.max(longestIncreasing[j] + 1, longestIncreasing[i]);
        //            result = Math.max(result, longestIncreasing[i]);
        //        }
        //    }
        // }
        //!!!!!!!!!!!!!!!!!!!!!!!!!     КОНЕЦ ЗАДАЧИ     !!!!!!!!!!!!!!!!!!!!!!!!!
